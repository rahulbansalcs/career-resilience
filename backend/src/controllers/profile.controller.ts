...
export const listUserSkillsController=async(req:Request,res:Response)=>{
try{
...
export const updateUserSkillController=async(req:Request,res:Response)=>{
try{
...
export const deleteUserSkillController=async(req:Request,res:Response)=>{
try{
const skillId=String(req.params.skillId)
