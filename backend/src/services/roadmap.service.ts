...
export const generateRoadmap=async(userId:string,careerRoleId:string)=>{
...
if(gaps.length===0) throw new Error("NO_SKILL_GAPS")
...
export const updateUserRoadmapItemStatus=async(userId:string,itemId:string,status:"pending"|"in_progress"|"completed")=>{
