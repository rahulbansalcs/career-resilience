...
export const listRoadmapsController = async (req, res) => {
    try {
...
export const updateRoadmapItemStatusController = async (req, res) => {
    try {
        ...
        const item = await updateUserRoadmapItemStatus(getUserId(req), itemId, status);
        if (!item) {
