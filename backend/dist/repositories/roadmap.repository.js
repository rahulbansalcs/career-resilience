...
export const createRoadmap = async (userId, careerRoleId, title, description) => {
...
export const createRoadmapItem = async (roadmapId, title, description, itemType, priority, estimatedHours, dueDate) => {
...
export const getRoadmapItems = async (roadmapId) => {
...
export const createRoadmapWithItems = async (userId, careerRoleId, title, description, items) => {
...
export const updateRoadmapItemStatus = async (userId, roadmapItemId, status) => {
