...
export const createUser = async (email, passwordHash, firstName, lastName) => {
    const result = await pool.query("INSERT INTO users(email,password_hash,first_name,last_name) VALUES($1,$2,$3,$4) RETURNING id,email,first_name,last_name,created_at,updated_at", [email, passwordHash, firstName, lastName || null]);
